...
/* HardwareConfig */
#define RIL_HARDWARE_CONFIG_MODEM 0
#define RIL_HARDWARE_CONFIG_SIM 1

#define RIL_HARDWARE_CONFIG_STATE_ENABLED 0
#define RIL_HARDWARE_CONFIG_STATE_STANDBY 1
#define RIL_HARDWARE_CONFIG_STATE_DISABLED 2
